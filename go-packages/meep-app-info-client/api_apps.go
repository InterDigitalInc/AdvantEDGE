...
*/
func (a *AppsApiService) ApplicationsAppInstanceIdDELETE(ctx context.Context, appInstanceId string) (*http.Response, error) {
	var (
...
*/
func (a *AppsApiService) ApplicationsAppInstanceIdGET(ctx context.Context, appInstanceId string) (ApplicationInfo, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body New ApplicationInfo with updated &quot;state&quot; is included as entity body of the request
 * @param appInstanceId Represents a MEC application instance. Note that the appInstanceId is allocated by the MEC application manager POST method.

@return ApplicationInfo
*/
func (a *AppsApiService) ApplicationsAppInstanceIdPUT(ctx context.Context, body ApplicationInfo, appInstanceId string) (ApplicationInfo, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ApplicationsGETOpts - Optional Parameters:
     * @param "AppName" (optional.String) -  A MEC application manager may use app_name as an input parameter to query the existence of a list of MEC application instances with the same name.
     * @param "AppState" (optional.String) -  A MEC application manager may use app_state as an input parameter to query the state of a list of MEC application instances with the same state.
...
func (a *AppsApiService) ApplicationsGET(ctx context.Context, localVarOptionals *ApplicationsGETOpts) ([]ApplicationInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return ApplicationInfo
*/
func (a *AppsApiService) ApplicationsPOST(ctx context.Context, body ApplicationInfo) (ApplicationInfo, *http.Response, error) {
	var (
