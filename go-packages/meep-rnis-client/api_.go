...
/*
DefaultApiService Retrieve information on layer 2 measurements
...
func (a *DefaultApiService) Layer2MeasInfoGET(ctx context.Context, localVarOptionals *Layer2MeasInfoGETOpts) (InlineResponse2003, *http.Response, error) {
	var (
...
/*
DefaultApiService Retrieve information on the underlying Mobile Network that the MEC application is associated to
...
/*
DefaultApiService Retrieve information on Radio Access Bearers
...
/*
DefaultApiService Retrieve S1-U bearer information related to specific UE(s)
...
/*
DefaultApiService Retrieve information on subscriptions for notifications
 ...
 * @param optional nil or *SubscriptionLinkListSubscriptionsGETOpts - Optional Parameters:
     * @param "SubscriptionType" (optional.String) -  Subscription type filter
...
func (a *DefaultApiService) SubscriptionLinkListSubscriptionsGET(ctx context.Context, localVarOptionals *SubscriptionLinkListSubscriptionsGETOpts) (InlineResponse2004, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
DefaultApiService Cancel an existing subscription
...
/*
DefaultApiService Retrieve information on current specific subscription
...
*/
func (a *DefaultApiService) SubscriptionsGET(ctx context.Context, subscriptionId string) (InlineResponse2005, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *DefaultApiService) SubscriptionsPOST(ctx context.Context, body Body) (InlineResponse201, *http.Response, error) {
	var (
...
/*
DefaultApiService Modify an existing subscription
...
*/
func (a *DefaultApiService) SubscriptionsPUT(ctx context.Context, body Body1, subscriptionId string) (InlineResponse2006, *http.Response, error) {
	var (
