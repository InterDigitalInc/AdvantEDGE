...
func TestScenarioUpdate(t *testing.T) {
	...
	nodes := []dataModel.ScenarioNode{ue_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	}
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue", NodeDataUnion: &ue_data, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue", Type_: NodeTypeUE, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue", Type_: NodeTypeUE, NodeDataUnion: &ue_data}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue", Type_: NodeTypeUE, NodeDataUnion: &ue_data, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue1_node := dataModel.ScenarioNode{Name: "ue1", Type_: NodeTypeUE, NodeDataUnion: &ue1_data, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue1_node}
	err = m.AddScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	}
	...
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.RemoveScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	}
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue"}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.RemoveScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue_data = dataModel.NodeDataUnion{}
	ue_node = dataModel.ScenarioNode{Name: "ue", Type_: NodeTypeUE}
	nodes = []dataModel.ScenarioNode{ue_node}
	err = m.RemoveScenarioNodes(&nodes)
	if err == nil {
		t.Fatalf("Action should have failed")
	...
	ue3_node := dataModel.ScenarioNode{Name: "ue3", Type_: NodeTypeUE, NodeDataUnion: &ue3_data, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue3_node}
	err = m.AddScenarioNodes(&nodes)
	if err != nil {
	...
	ue4_node := dataModel.ScenarioNode{Name: "ue4", Type_: NodeTypeUE, NodeDataUnion: &ue4_data, Parent: "zone1-poa1"}
	ue5_pl := dataModel.PhysicalLocation{Id: "ue5-id", Name: "ue5", Type_: NodeTypeUE}
	ue5_data := dataModel.NodeDataUnion{PhysicalLocation: &ue5_pl}
	ue5_node := dataModel.ScenarioNode{Name: "ue5", Type_: NodeTypeUE, NodeDataUnion: &ue5_data, Parent: "zone1-poa1"}
	nodes = []dataModel.ScenarioNode{ue4_node, ue5_node}
	err = m.AddScenarioNodes(&nodes)
	if err != nil {
		t.Fatalf("Error adding nodes")
	}
	...
	ue4_node = dataModel.ScenarioNode{Name: "ue4", Type_: NodeTypeUE}
	nodes = []dataModel.ScenarioNode{ue4_node}
	err = m.RemoveScenarioNodes(&nodes)
	if err != nil {
	...
	ue3_node = dataModel.ScenarioNode{Name: "ue3", Type_: NodeTypeUE}
	ue5_node = dataModel.ScenarioNode{Name: "ue5", Type_: NodeTypeUE}
	nodes = []dataModel.ScenarioNode{ue3_node, ue5_node}
	err = m.RemoveScenarioNodes(&nodes)
	if err != nil {
		t.Fatalf("Error removing nodes")
	}
