 ...
 * @param optional nil or *ServicesGETOpts - Optional Parameters:
     * @param "AppInstanceId" (optional.String) -  MEC application instance identifier
...
func (a *ServicesApiService) ServicesGET(ctx context.Context, localVarOptionals *ServicesGETOpts) ([]ServiceInfo, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.AppInstanceId.IsSet() {
		localVarQueryParams.Add("appInstanceId", parameterToString(localVarOptionals.AppInstanceId.Value(), ""))
	}
