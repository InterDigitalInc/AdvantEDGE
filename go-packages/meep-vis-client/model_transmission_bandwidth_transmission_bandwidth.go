...
const (
	BW6   TransmissionBandwidthTransmissionBandwidth = 1
	BW15  TransmissionBandwidthTransmissionBandwidth = 2
	BW25  TransmissionBandwidthTransmissionBandwidth = 3
	BW50  TransmissionBandwidthTransmissionBandwidth = 4
	BW75  TransmissionBandwidthTransmissionBandwidth = 5
	BW100 TransmissionBandwidthTransmissionBandwidth = 6
)
