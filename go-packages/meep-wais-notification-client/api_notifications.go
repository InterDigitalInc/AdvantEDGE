...
/*
NotificationsApiService This operation is used by the AdvantEDGE WAI Service to issue a notification with regards to expiry of an existing subscription
...
/*
NotificationsApiService This operation is used by the AdvantEDGE WAI Service to issue a callback notification
...
*/
func (a *NotificationsApiService) PostNotification(ctx context.Context, subscriptionId string, notification Notification) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/notifications/{subscriptionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"subscriptionId"+"}", fmt.Sprintf("%v", subscriptionId), -1)
