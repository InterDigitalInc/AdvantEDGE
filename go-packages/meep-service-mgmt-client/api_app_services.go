...
func (a *AppServicesApiService) AppServicesGET(ctx context.Context, appInstanceId string, localVarOptionals *AppServicesGETOpts) ([]ServiceInfo, *http.Response, error) {
	var (
...
@return ServiceInfo
*/
func (a *AppServicesApiService) AppServicesPOST(ctx context.Context, body ServiceInfoPost, appInstanceId string) (ServiceInfo, *http.Response, error) {
	var (
...
*/
func (a *AppServicesApiService) AppServicesServiceIdDELETE(ctx context.Context, appInstanceId string, serviceId string) (*http.Response, error) {
	var (
...
@return ServiceInfo
*/
func (a *AppServicesApiService) AppServicesServiceIdGET(ctx context.Context, appInstanceId string, serviceId string) (ServiceInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return ServiceInfo
*/
func (a *AppServicesApiService) AppServicesServiceIdPUT(ctx context.Context, body ServiceInfo, appInstanceId string, serviceId string) (ServiceInfo, *http.Response, error) {
	var (
