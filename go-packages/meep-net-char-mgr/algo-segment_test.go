...
func TestSegAlgoCalculation(t *testing.T) {
	...
	updatedNetCharList = algo.CalculateNetChar()
	if len(updatedNetCharList) != 2 {
		t.Fatalf("Invalid net char update list", len(updatedNetCharList))
	}
