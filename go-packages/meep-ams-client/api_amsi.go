...
/*
AmsiApiService delivers a notification from the AMS resource to the subscriber
...
*/
func (a *AmsiApiService) NotificationPOST(ctx context.Context, body InlineNotification) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
