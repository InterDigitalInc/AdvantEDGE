...
type AdjAppInstApiService service

/*
AdjAppInstApiService Retrieve information about this subscription.
...
func (a *AdjAppInstApiService) AdjAppInstGET(ctx context.Context, localVarOptionals *AdjAppInstGETOpts) ([]AdjacentAppInstanceInfo, *http.Response, error) {
	var (
