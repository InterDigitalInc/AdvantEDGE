...
package client
// ContextTransferState : If present, it represents the state of transferring the user context to another application instance. The applicable values are: 0 = NOT_TRANSFERRED, 1= USER_CONTEXT_TRANSEFR_COMPLETED.
type ContextTransferState int32

// List of ContextTransferState
const (
	0__ContextTransferState ContextTransferState = "0"
	1__ContextTransferState ContextTransferState = "1"
)
