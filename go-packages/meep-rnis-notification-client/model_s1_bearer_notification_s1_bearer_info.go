...
type S1BearerNotificationS1BearerInfo struct {
	EnbInfo *S1BearerNotificationEnbInfo `json:"enbInfo,omitempty"`
	...
	SGwInfo *S1BearerNotificationSGwInfo `json:"sGwInfo,omitempty"`
}
