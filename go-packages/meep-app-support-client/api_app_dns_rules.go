...
type AppDnsRulesApiService service

/*
AppDnsRulesApiService
...
@return DnsRule
*/
func (a *AppDnsRulesApiService) ApplicationsDnsRuleGET(ctx context.Context, appInstanceId string, dnsRuleId string) (DnsRule, *http.Response, error) {
	var (
...
@return DnsRule
*/
func (a *AppDnsRulesApiService) ApplicationsDnsRulePUT(ctx context.Context, body DnsRule, appInstanceId string, dnsRuleId string) (DnsRule, *http.Response, error) {
	var (
...
@return []DnsRule
*/
func (a *AppDnsRulesApiService) ApplicationsDnsRulesGET(ctx context.Context, appInstanceId string) ([]DnsRule, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
