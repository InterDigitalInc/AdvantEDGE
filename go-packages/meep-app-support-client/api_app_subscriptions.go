...
*/
func (a *AppSubscriptionsApiService) ApplicationsSubscriptionGET(ctx context.Context, appInstanceId string, subscriptionId string) (AppTerminationNotificationSubscription, *http.Response, error) {
	var (
...
*/
func (a *AppSubscriptionsApiService) ApplicationsSubscriptionsGET(ctx context.Context, appInstanceId string) (MecAppSuptApiSubscriptionLinkList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return AppTerminationNotificationSubscription
*/
func (a *AppSubscriptionsApiService) ApplicationsSubscriptionsPOST(ctx context.Context, body AppTerminationNotificationSubscription, appInstanceId string) (AppTerminationNotificationSubscription, *http.Response, error) {
	var (
