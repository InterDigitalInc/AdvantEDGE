...
type StaStatisticsConfig struct {
	...
	// Use triggered report ot not.
	TriggeredReport bool `json:"triggeredReport"`
	// Trigger timeout during which a measuring STA does not generate further triggered STA Statistics Reports.
	TriggerTimeout int32 `json:"triggerTimeout"`
	// Bitmap defining the metrics returned by the STA Statistics Report.
