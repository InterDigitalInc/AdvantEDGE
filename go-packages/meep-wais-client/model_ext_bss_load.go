...
type ExtBssLoad struct {
	// Total number of STAs currently associated with this BSS that have a 1 in the MU Beamforme Capable field of their VHT Capabilities.
	MuMimoStaCount int32 `json:"muMimoStaCount"`
	// Scaled percentage of time the AP has underutilized spatial dom,ain resources for given busy time of the medium.
