...
type BssLoad struct {
	// Total number of STAs currently associated with this BSS.
	StaCount int32 `json:"staCount"`
	// Scaled percentage of time the AP sensed the medium was busy.
	ChannelUtilization int32 `json:"channelUtilization"`
	// Remaining amount of medium time available via explicit admission control, in units of 32us/s.
