...
// APIClient manages communication with the AdvantEDGE GIS Engine REST API API v1.0.0
...
type APIClient struct {
	...
	GeospatialDataApi *GeospatialDataApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.GeospatialDataApi = (*GeospatialDataApiService)(&c.common)
