...
type ResponseZoneStatusNotificationSubscriptionList struct {
	NotificationSubscriptionList *ZoneStatusNotificationSubscriptionList `json:"notificationSubscriptionList,omitempty"`
}
