...
type ResponseZonalTrafficNotificationSubscriptionList struct {
	NotificationSubscriptionList *ZonalTrafficNotificationSubscriptionList `json:"notificationSubscriptionList,omitempty"`
}
