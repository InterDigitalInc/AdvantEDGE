...
func (a *UsersApiService) UsersGet(ctx context.Context, zoneId string, localVarOptionals *UsersGetOpts) (interface{}, *http.Response, error) {
	var (
...
@return interface{}
*/
func (a *UsersApiService) UsersGetById(ctx context.Context, userId string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
