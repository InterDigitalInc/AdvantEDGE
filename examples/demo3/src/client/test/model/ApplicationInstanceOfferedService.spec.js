...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApplicationInstanceOfferedService', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.ApplicationInstanceOfferedService();
      });

      it('should create an instance of ApplicationInstanceOfferedService', function() {
        // TODO: update the code to test ApplicationInstanceOfferedService
        expect(instance).to.be.a(MecDemo3Api.ApplicationInstanceOfferedService);
      });
