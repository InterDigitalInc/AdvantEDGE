...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LinkType2', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.LinkType2();
      });

      it('should create an instance of LinkType2', function() {
        // TODO: update the code to test LinkType2
        expect(instance).to.be.a(MecDemo3Api.LinkType2);
      });
