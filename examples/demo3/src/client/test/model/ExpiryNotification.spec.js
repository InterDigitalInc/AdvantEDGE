...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExpiryNotification', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.ExpiryNotification();
      });

      it('should create an instance of ExpiryNotification', function() {
        // TODO: update the code to test ExpiryNotification
        expect(instance).to.be.a(MecDemo3Api.ExpiryNotification);
      });
      ...
      it('should have the property expiryDeadline (base name: "expiryDeadline")', function() {
        // TODO: update the code to test the property expiryDeadline
        expect(instance).to.have.property('expiryDeadline');
        // expect(instance.expiryDeadline).to.be(expectedValueLiteral);
      });
