...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdjacentAppInfoNotification', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.AdjacentAppInfoNotification();
      });

      it('should create an instance of AdjacentAppInfoNotification', function() {
        // TODO: update the code to test AdjacentAppInfoNotification
        expect(instance).to.be.a(MecDemo3Api.AdjacentAppInfoNotification);
      });
      ...
      it('should have the property adjacentAppInfo (base name: "adjacentAppInfo")', function() {
        // TODO: update the code to test the property adjacentAppInfo
        expect(instance).to.have.property('adjacentAppInfo');
        // expect(instance.adjacentAppInfo).to.be(expectedValueLiteral);
      });
