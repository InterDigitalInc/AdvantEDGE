...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApplicationInstanceDiscoveredServices', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.ApplicationInstanceDiscoveredServices();
      });

      it('should create an instance of ApplicationInstanceDiscoveredServices', function() {
        // TODO: update the code to test ApplicationInstanceDiscoveredServices
        expect(instance).to.be.a(MecDemo3Api.ApplicationInstanceDiscoveredServices);
      });
