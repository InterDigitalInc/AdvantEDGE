...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MobilityStatus', function() {
      beforeEach(function() {
        instance = MecDemo3Api.MobilityStatus;
      });

      it('should create an instance of MobilityStatus', function() {
        // TODO: update the code to test MobilityStatus
        expect(instance).to.be.a('object');
      });

      it('should have the property TRIGGERED', function() {
        expect(instance).to.have.property('TRIGGERED');
        expect(instance.TRIGGERED).to.be(&quot;INTERHOST_MOVEOUT_TRIGGERED&quot;);
      });

      it('should have the property COMPLETED', function() {
        expect(instance).to.have.property('COMPLETED');
        expect(instance.COMPLETED).to.be(&quot;INTERHOST_MOVEOUT_COMPLETED&quot;);
      });

      it('should have the property FAILED', function() {
        expect(instance).to.have.property('FAILED');
        expect(instance.FAILED).to.be(&quot;INTERHOST_MOVEOUT_FAILED&quot;);
      });
