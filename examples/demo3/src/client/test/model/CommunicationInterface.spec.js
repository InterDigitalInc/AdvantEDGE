...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommunicationInterface', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.CommunicationInterface();
      });

      it('should create an instance of CommunicationInterface', function() {
        // TODO: update the code to test CommunicationInterface
        expect(instance).to.be.a(MecDemo3Api.CommunicationInterface);
      });
