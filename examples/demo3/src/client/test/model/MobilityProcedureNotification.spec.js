...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MobilityProcedureNotification', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.MobilityProcedureNotification();
      });

      it('should create an instance of MobilityProcedureNotification', function() {
        // TODO: update the code to test MobilityProcedureNotification
      ...
      it('should have the property mobilityStatus (base name: "mobilityStatus")', function() {
        // TODO: update the code to test the property mobilityStatus
        expect(instance).to.have.property('mobilityStatus');
