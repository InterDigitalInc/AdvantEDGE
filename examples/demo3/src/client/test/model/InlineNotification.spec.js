...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineNotification', function() {
      beforeEach(function() {
        instance = new MecDemo3Api.InlineNotification();
      });

      it('should create an instance of InlineNotification', function() {
        // TODO: update the code to test InlineNotification
        expect(instance).to.be.a(MecDemo3Api.InlineNotification);
      });
