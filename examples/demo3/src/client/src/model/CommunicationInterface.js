...
(function(root, factory) {
  ...
  /**
   * The CommunicationInterface model module.
   * @module model/CommunicationInterface
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>CommunicationInterface</code>.
   * @alias module:model/CommunicationInterface
   * @class
   */
  ...
  /**
   * Constructs a <code>CommunicationInterface</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommunicationInterface} obj Optional instance to populate.
   * @return {module:model/CommunicationInterface} The populated <code>CommunicationInterface</code> instance.
   */
