...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MecDemo3Api.MobilityProcedureNotificationTargetAppInfo = factory(root.MecDemo3Api.ApiClient, root.MecDemo3Api.CommunicationInterface);
  }
}(this, function(ApiClient, CommunicationInterface) {
  'use strict';

  /**
   * The MobilityProcedureNotificationTargetAppInfo model module.
   * @module model/MobilityProcedureNotificationTargetAppInfo
   * @version 0.0.1
   */
  ...
  /**
   * Constructs a <code>MobilityProcedureNotificationTargetAppInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MobilityProcedureNotificationTargetAppInfo} obj Optional instance to populate.
   * @return {module:model/MobilityProcedureNotificationTargetAppInfo} The populated <code>MobilityProcedureNotificationTargetAppInfo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('commInterface'))
        obj.commInterface = CommunicationInterface.constructFromObject(data['commInterface']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CommunicationInterface} commInterface
   */
