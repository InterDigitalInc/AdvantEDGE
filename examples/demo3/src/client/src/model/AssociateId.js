...
(function(root, factory) {
  ...
  /**
   * The AssociateId model module.
   * @module model/AssociateId
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>AssociateId</code>.
   * @alias module:model/AssociateId
   * @class
   */
  ...
  /**
   * Constructs a <code>AssociateId</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssociateId} obj Optional instance to populate.
   * @return {module:model/AssociateId} The populated <code>AssociateId</code> instance.
   */
