...
type AddressChangeNotification struct {
	// Identifier of the user application instance.
	AppInstanceId string `json:"appInstanceId"`
	// Uniquely identifies the application context in the MEC system.
	ContextId string `json:"contextId"`
	// Shall be set to \"AddressChangeNotification\".
	NotificationType string `json:"notificationType"`
	// Address of the user application. Used as the reference URI for the application. Assigned by the MEC system.
