...
(function(root, factory) {
  ...
  describe('TrackingNotification', function() {
    it('should create an instance of TrackingNotification', function() {
      ...
      //var instance = new MeepDemoAppApi.TrackingNotification();
    ...
    it('should have the property interestRealma (base name: "interestRealma")', function() {
      // uncomment below and update the code to test the property interestRealma
      //var instance = new MeepDemoAppApi.TrackingNotification();
      //expect(instance).to.be();
    });
