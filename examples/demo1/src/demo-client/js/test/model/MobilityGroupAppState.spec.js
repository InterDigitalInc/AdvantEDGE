...
(function(root, factory) {
  ...
  describe('MobilityGroupAppState', function() {
    it('should create an instance of MobilityGroupAppState', function() {
      // uncomment below and update the code to test MobilityGroupAppState
      //var instance = new MeepDemoAppApi.MobilityGroupAppState();
    ...
    it('should have the property ueState (base name: "ueState")', function() {
      // uncomment below and update the code to test the property ueState
      //var instance = new MeepDemoAppApi.MobilityGroupAppState();
      //expect(instance).to.be();
    });
