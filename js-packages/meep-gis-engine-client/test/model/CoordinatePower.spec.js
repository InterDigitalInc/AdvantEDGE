...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoordinatePower', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.CoordinatePower();
      });

      it('should create an instance of CoordinatePower', function() {
        // TODO: update the code to test CoordinatePower
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.CoordinatePower);
      });
      ...
      it('should have the property rsrq (base name: "rsrq")', function() {
        // TODO: update the code to test the property rsrq
        expect(instance).to.have.property('rsrq');
        // expect(instance.rsrq).to.be(expectedValueLiteral);
      });

      it('should have the property rsrp (base name: "rsrp")', function() {
        // TODO: update the code to test the property rsrp
        expect(instance).to.have.property('rsrp');
        // expect(instance.rsrp).to.be(expectedValueLiteral);
      });

      it('should have the property poaName (base name: "poaName")', function() {
        // TODO: update the code to test the property poaName
        expect(instance).to.have.property('poaName');
        // expect(instance.poaName).to.be(expectedValueLiteral);
      });
