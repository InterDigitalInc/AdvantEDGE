...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DistanceResponse', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.DistanceResponse();
      });

      it('should create an instance of DistanceResponse', function() {
        // TODO: update the code to test DistanceResponse
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.DistanceResponse);
      });
