...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TargetRange', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.TargetRange();
      });

      it('should create an instance of TargetRange', function() {
        // TODO: update the code to test TargetRange
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.TargetRange);
      });
