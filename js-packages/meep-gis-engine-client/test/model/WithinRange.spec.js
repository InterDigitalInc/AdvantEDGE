...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WithinRange', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.WithinRange();
      });

      it('should create an instance of WithinRange', function() {
        // TODO: update the code to test WithinRange
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.WithinRange);
      });
