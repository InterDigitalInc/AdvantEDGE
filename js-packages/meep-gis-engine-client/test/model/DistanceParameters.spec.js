...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DistanceParameters', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.DistanceParameters();
      });

      it('should create an instance of DistanceParameters', function() {
        // TODO: update the code to test DistanceParameters
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.DistanceParameters);
      });
