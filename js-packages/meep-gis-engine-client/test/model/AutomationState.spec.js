...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AutomationState', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.AutomationState();
      });

      it('should create an instance of AutomationState', function() {
        // TODO: update the code to test AutomationState
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.AutomationState);
      });
