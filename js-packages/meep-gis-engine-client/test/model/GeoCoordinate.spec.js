...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GeoCoordinate', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.GeoCoordinate();
      });

      it('should create an instance of GeoCoordinate', function() {
        // TODO: update the code to test GeoCoordinate
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.GeoCoordinate);
      });
