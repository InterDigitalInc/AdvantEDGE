...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TargetPoint', function() {
      beforeEach(function() {
        instance = new AdvantEdgeGisEngineRestApi.TargetPoint();
      });

      it('should create an instance of TargetPoint', function() {
        // TODO: update the code to test TargetPoint
        expect(instance).to.be.a(AdvantEdgeGisEngineRestApi.TargetPoint);
      });
