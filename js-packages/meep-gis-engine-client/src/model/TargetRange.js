...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeGisEngineRestApi.TargetRange = factory(root.AdvantEdgeGisEngineRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TargetRange model module.
   * @module model/TargetRange
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TargetRange</code>.
   * Parameters for within range query purpose.
   * @alias module:model/TargetRange
   * @class
  ...
  /**
   * Constructs a <code>TargetRange</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TargetRange} obj Optional instance to populate.
   * @return {module:model/TargetRange} The populated <code>TargetRange</code> instance.
   */
