...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeGisEngineRestApi.TargetPoint = factory(root.AdvantEdgeGisEngineRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TargetPoint model module.
   * @module model/TargetPoint
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TargetPoint</code>.
   * Parameters for distance query purpose.
   * @alias module:model/TargetPoint
   * @class
   */
  ...
  /**
   * Constructs a <code>TargetPoint</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TargetPoint} obj Optional instance to populate.
   * @return {module:model/TargetPoint} The populated <code>TargetPoint</code> instance.
   */
