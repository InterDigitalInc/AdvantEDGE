...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeGisEngineRestApi.WithinRangeParameters = factory(root.AdvantEdgeGisEngineRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The WithinRangeParameters model module.
   * @module model/WithinRangeParameters
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>WithinRangeParameters</code>.
   * Parameters for within range query purpose.
   * @alias module:model/WithinRangeParameters
   * @class
   * @param radius {Number} Radius (in meters) around the location.
   */
  var exports = function(radius) {
    this.radius = radius;
  };

  /**
   * Constructs a <code>WithinRangeParameters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WithinRangeParameters} obj Optional instance to populate.
   * @return {module:model/WithinRangeParameters} The populated <code>WithinRangeParameters</code> instance.
   */
