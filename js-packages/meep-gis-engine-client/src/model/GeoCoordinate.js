...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeGisEngineRestApi.GeoCoordinate = factory(root.AdvantEdgeGisEngineRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The GeoCoordinate model module.
   * @module model/GeoCoordinate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GeoCoordinate</code>.
   * Geo-coordinates for cellular power.
   * @alias module:model/GeoCoordinate
   * @class
   */
  ...
  /**
   * Constructs a <code>GeoCoordinate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GeoCoordinate} obj Optional instance to populate.
   * @return {module:model/GeoCoordinate} The populated <code>GeoCoordinate</code> instance.
   */
