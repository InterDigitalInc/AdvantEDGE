...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgePlatformControllerRestApi.ReplayInfo = factory(root.AdvantEdgePlatformControllerRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ReplayInfo model module.
   * @module model/ReplayInfo
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ReplayInfo</code>.
   * Scenario information
   * @alias module:model/ReplayInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>ReplayInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReplayInfo} obj Optional instance to populate.
   * @return {module:model/ReplayInfo} The populated <code>ReplayInfo</code> instance.
   */
   ...
   */
  exports.prototype.scenarioName = undefined;
