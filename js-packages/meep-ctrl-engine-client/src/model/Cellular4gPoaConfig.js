...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgePlatformControllerRestApi.Cellular4gPoaConfig = factory(root.AdvantEdgePlatformControllerRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Cellular4gPoaConfig model module.
   * @module model/Cellular4gPoaConfig
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Cellular4gPoaConfig</code>.
   * Cellular 4G POA configuration information
   * @alias module:model/Cellular4gPoaConfig
   * @class
   */
  ...
  /**
   * Constructs a <code>Cellular4gPoaConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Cellular4gPoaConfig} obj Optional instance to populate.
   * @return {module:model/Cellular4gPoaConfig} The populated <code>Cellular4gPoaConfig</code> instance.
   */
