  ...
  describe('ScenarioExecutionApi', function() {
    describe('activateScenario', function() {
      it('should call activateScenario successfully', function(done) {
        //uncomment below and update the code to test activateScenario
        //instance.activateScenario(function(error) {
    ...
    describe('getActiveScenario', function() {
      it('should call getActiveScenario successfully', function(done) {
        //uncomment below and update the code to test getActiveScenario
        //instance.getActiveScenario(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('terminateScenario', function() {
      it('should call terminateScenario successfully', function(done) {
        //uncomment below and update the code to test terminateScenario
        //instance.terminateScenario(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
