...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MeepControllerRestApi.ScenarioExecutionApi();
  });
    ...
    describe('ScenarioExecutionApi', function() {
        ...
        it('should call getActiveNodeServiceMaps successfully', function(done) {
          ...
          instance.getActiveNodeServiceMaps(opts, function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(MeepControllerRestApi.NodeServiceMaps);
      ...
      describe('sendEvent', function() {
        it('should call sendEvent successfully', function(done) {
          ...
          var event = new MeepControllerRestApi.Event();
          event.name = "";
          event.type = "NETWORK-CHARACTERISTICS-UPDATE";
          event.eventNetworkCharacteristicsUpdate = new MeepControllerRestApi.EventNetworkCharacteristicsUpdate();
          ...
          event.eventMobility = new MeepControllerRestApi.EventMobility();
          event.eventMobility.elementName = "";
          event.eventMobility.dest = "";
          event.eventPoasInRange = new MeepControllerRestApi.EventPoasInRange();
          event.eventPoasInRange.ue = "";
          event.eventPoasInRange.poasInRange = [""];
          event.eventOther = new MeepControllerRestApi.EventOther();
