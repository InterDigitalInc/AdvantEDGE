...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Cellular4gDomainConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.Cellular4gDomainConfig();
      });

      it('should create an instance of Cellular4gDomainConfig', function() {
        // TODO: update the code to test Cellular4gDomainConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.Cellular4gDomainConfig);
      });
