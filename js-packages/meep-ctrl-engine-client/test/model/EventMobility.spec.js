...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventMobility', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.EventMobility();
      });

      it('should create an instance of EventMobility', function() {
        // TODO: update the code to test EventMobility
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.EventMobility);
      });
