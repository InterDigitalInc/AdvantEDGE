...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GpuConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.GpuConfig();
      });

      it('should create an instance of GpuConfig', function() {
        // TODO: update the code to test GpuConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.GpuConfig);
      });
