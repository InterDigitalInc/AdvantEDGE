...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventPoasInRange', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.EventPoasInRange();
      });

      it('should create an instance of EventPoasInRange', function() {
        // TODO: update the code to test EventPoasInRange
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.EventPoasInRange);
      });
      ...
      it('should have the property poasInRange (base name: "poasInRange")', function() {
        // TODO: update the code to test the property poasInRange
        expect(instance).to.have.property('poasInRange');
        // expect(instance.poasInRange).to.be(expectedValueLiteral);
      });
