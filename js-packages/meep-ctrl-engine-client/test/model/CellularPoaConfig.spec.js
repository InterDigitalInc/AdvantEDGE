...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CellularPoaConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.CellularPoaConfig();
      });

      it('should create an instance of CellularPoaConfig', function() {
        // TODO: update the code to test CellularPoaConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.CellularPoaConfig);
      });
