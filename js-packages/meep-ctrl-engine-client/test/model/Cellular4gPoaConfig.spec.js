...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Cellular4gPoaConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.Cellular4gPoaConfig();
      });

      it('should create an instance of Cellular4gPoaConfig', function() {
        // TODO: update the code to test Cellular4gPoaConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.Cellular4gPoaConfig);
      });
