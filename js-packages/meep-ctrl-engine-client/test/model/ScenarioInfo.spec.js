...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScenarioInfo', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ScenarioInfo();
      });

      it('should create an instance of ScenarioInfo', function() {
        // TODO: update the code to test ScenarioInfo
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ScenarioInfo);
      });
