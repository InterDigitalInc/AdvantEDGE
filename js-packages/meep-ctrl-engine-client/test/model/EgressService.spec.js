...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EgressService', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.EgressService();
      });

      it('should create an instance of EgressService', function() {
        // TODO: update the code to test EgressService
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.EgressService);
      });
