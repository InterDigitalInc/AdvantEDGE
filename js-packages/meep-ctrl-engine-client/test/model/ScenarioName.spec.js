...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScenarioName', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ScenarioName();
      });

      it('should create an instance of ScenarioName', function() {
        // TODO: update the code to test ScenarioName
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ScenarioName);
      });
