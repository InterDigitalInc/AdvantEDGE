...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReplayFileList', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ReplayFileList();
      });

      it('should create an instance of ReplayFileList', function() {
        // TODO: update the code to test ReplayFileList
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ReplayFileList);
      });

      it('should have the property replayFiles (base name: "replay-files")', function() {
        // TODO: update the code to test the property replayFiles
        expect(instance).to.have.property('replayFiles');
        // expect(instance.replayFiles).to.be(expectedValueLiteral);
      });
