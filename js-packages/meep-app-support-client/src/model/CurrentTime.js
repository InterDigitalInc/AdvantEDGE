...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecApplicationSupportApi.CurrentTime = factory(root.AdvantEdgeMecApplicationSupportApi.ApiClient);
  }
   ...
   * @param timeSourceStatus {module:model/CurrentTime.TimeSourceStatusEnum} Platform Time Source status. 1 = TRACEABLE - time source is locked to the UTC time source. 2 = NONTRACEABLE - time source is not locked to the UTC time source
   */
  var exports = function(seconds, nanoSeconds, timeSourceStatus) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('timeSourceStatus'))
        obj.timeSourceStatus = ApiClient.convertToType(data['timeSourceStatus'], 'String');
    }
    return obj;
  }
   ...
   * @member {module:model/CurrentTime.TimeSourceStatusEnum} timeSourceStatus
   */
  exports.prototype.timeSourceStatus = undefined;


  /**
   * Allowed values for the <code>timeSourceStatus</code> property.
   * @enum {String}
   * @readonly
   */
  exports.TimeSourceStatusEnum = {
    /**
     * value: "TRACEABLE"
     * @const
     */
