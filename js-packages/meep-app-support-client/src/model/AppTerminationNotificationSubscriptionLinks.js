...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscriptionLinks = factory(root.AdvantEdgeMecApplicationSupportApi.ApiClient, root.AdvantEdgeMecApplicationSupportApi.LinkType);
  }
}(this, function(ApiClient, LinkType) {
  'use strict';

  /**
   * The AppTerminationNotificationSubscriptionLinks model module.
   * @module model/AppTerminationNotificationSubscriptionLinks
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>AppTerminationNotificationSubscriptionLinks</code>.
   * Self-referring URI.
   * @alias module:model/AppTerminationNotificationSubscriptionLinks
   * @class
  ...
  /**
   * Constructs a <code>AppTerminationNotificationSubscriptionLinks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppTerminationNotificationSubscriptionLinks} obj Optional instance to populate.
   * @return {module:model/AppTerminationNotificationSubscriptionLinks} The populated <code>AppTerminationNotificationSubscriptionLinks</code> instance.
   */
