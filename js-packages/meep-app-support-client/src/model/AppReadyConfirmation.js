...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecApplicationSupportApi.AppReadyConfirmation = factory(root.AdvantEdgeMecApplicationSupportApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AppReadyConfirmation model module.
   * @module model/AppReadyConfirmation
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>AppReadyConfirmation</code>.
   ...
   * @alias module:model/AppReadyConfirmation
   * @class
   * @param indication {module:model/AppReadyConfirmation.IndicationEnum} Indication about the MEC application instance.
   */
  var exports = function(indication) {
    this.indication = indication;
  };

  /**
   * Constructs a <code>AppReadyConfirmation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppReadyConfirmation} obj Optional instance to populate.
   * @return {module:model/AppReadyConfirmation} The populated <code>AppReadyConfirmation</code> instance.
   */
   ...
   * @member {module:model/AppReadyConfirmation.IndicationEnum} indication
   */
  exports.prototype.indication = undefined;


  /**
   * Allowed values for the <code>indication</code> property.
   * @enum {String}
   * @readonly
   */
  exports.IndicationEnum = {
    /**
     * value: "READY"
     * @const
     */
