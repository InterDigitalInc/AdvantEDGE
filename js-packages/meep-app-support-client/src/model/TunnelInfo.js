...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecApplicationSupportApi.TunnelInfo = factory(root.AdvantEdgeMecApplicationSupportApi.ApiClient);
  }
   ...
   * @class
   * @param tunnelType {module:model/TunnelInfo.TunnelTypeEnum} This type represents the tunnel information.
   */
  var exports = function(tunnelType) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tunnelType'))
        obj.tunnelType = ApiClient.convertToType(data['tunnelType'], 'String');
  ...
  /**
   * This type represents the tunnel information.
   * @member {module:model/TunnelInfo.TunnelTypeEnum} tunnelType
   */
  exports.prototype.tunnelType = undefined;

  /**
   * Destination address of the tunnel
   * @member {String} tunnelDstAddress
   */
  exports.prototype.tunnelDstAddress = undefined;

  /**
   * Source address of the tunnel
   * @member {String} tunnelSrcAddress
   */
  exports.prototype.tunnelSrcAddress = undefined;


  /**
   * Allowed values for the <code>tunnelType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.TunnelTypeEnum = {
    /**
     * value: "GTP_U"
     * @const
     */
