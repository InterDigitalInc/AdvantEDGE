    ...
    describe('MecAppSupportApi', function() {
      describe('applicationsConfirmReadyPOST', function() {
        it('should call applicationsConfirmReadyPOST successfully', function(done) {
          ...
          instance.applicationsConfirmReadyPOST(body, appInstanceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('applicationsConfirmTerminationPOST', function() {
        it('should call applicationsConfirmTerminationPOST successfully', function(done) {
          ...
          instance.applicationsConfirmTerminationPOST(body, appInstanceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('applicationsSubscriptionGET', function() {
        it('should call applicationsSubscriptionGET successfully', function(done) {
          ...
          instance.applicationsSubscriptionGET(appInstanceId, subscriptionId, function(error, data, response) {
            ...
            expect(data).to.be.a(AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscription);
      ...
      describe('applicationsSubscriptionsGET', function() {
        it('should call applicationsSubscriptionsGET successfully', function(done) {
          ...
          instance.applicationsSubscriptionsGET(appInstanceId, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AdvantEdgeMecApplicationSupportApi.SubscriptionLinkList);
      ...
      describe('timingCapsGET', function() {
        it('should call timingCapsGET successfully', function(done) {
          ...
          instance.timingCapsGET(function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AdvantEdgeMecApplicationSupportApi.TimingCaps);
      ...
      describe('timingCurrentTimeGET', function() {
        it('should call timingCurrentTimeGET successfully', function(done) {
          ...
          instance.timingCurrentTimeGET(function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AdvantEdgeMecApplicationSupportApi.CurrentTime);
