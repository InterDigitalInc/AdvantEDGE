...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationNotificationSubscription', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscription();
      });

      it('should create an instance of AppTerminationNotificationSubscription', function() {
        // TODO: update the code to test AppTerminationNotificationSubscription
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscription);
      });
