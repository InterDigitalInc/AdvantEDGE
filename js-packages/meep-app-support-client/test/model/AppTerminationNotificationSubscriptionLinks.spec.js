...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationNotificationSubscriptionLinks', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscriptionLinks();
      });

      it('should create an instance of AppTerminationNotificationSubscriptionLinks', function() {
        // TODO: update the code to test AppTerminationNotificationSubscriptionLinks
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationSubscriptionLinks);
      });
