...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionLinkList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.SubscriptionLinkList();
      });

      it('should create an instance of SubscriptionLinkList', function() {
        // TODO: update the code to test SubscriptionLinkList
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.SubscriptionLinkList);
      });
