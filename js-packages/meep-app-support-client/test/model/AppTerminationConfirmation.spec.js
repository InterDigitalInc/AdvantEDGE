...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationConfirmation', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.AppTerminationConfirmation();
      });

      it('should create an instance of AppTerminationConfirmation', function() {
        // TODO: update the code to test AppTerminationConfirmation
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.AppTerminationConfirmation);
      });
