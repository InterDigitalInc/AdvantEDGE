...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionLinkListLinks', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.SubscriptionLinkListLinks();
      });

      it('should create an instance of SubscriptionLinkListLinks', function() {
        // TODO: update the code to test SubscriptionLinkListLinks
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.SubscriptionLinkListLinks);
      });
