...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppReadyConfirmation', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.AppReadyConfirmation();
      });

      it('should create an instance of AppReadyConfirmation', function() {
        // TODO: update the code to test AppReadyConfirmation
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.AppReadyConfirmation);
      });

      it('should have the property indication (base name: "indication")', function() {
        // TODO: update the code to test the property indication
        expect(instance).to.have.property('indication');
        // expect(instance.indication).to.be(expectedValueLiteral);
      });
