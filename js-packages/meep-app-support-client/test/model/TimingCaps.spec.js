...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TimingCaps', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.TimingCaps();
      });

      it('should create an instance of TimingCaps', function() {
        // TODO: update the code to test TimingCaps
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.TimingCaps);
      });
      ...
      it('should have the property ntpServers (base name: "ntpServers")', function() {
        // TODO: update the code to test the property ntpServers
        expect(instance).to.have.property('ntpServers');
        // expect(instance.ntpServers).to.be(expectedValueLiteral);
      });

      it('should have the property ptpMasters (base name: "ptpMasters")', function() {
        // TODO: update the code to test the property ptpMasters
        expect(instance).to.have.property('ptpMasters');
        // expect(instance.ptpMasters).to.be(expectedValueLiteral);
      });
