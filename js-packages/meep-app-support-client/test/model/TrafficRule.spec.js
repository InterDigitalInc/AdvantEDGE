...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrafficRule', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.TrafficRule();
      });

      it('should create an instance of TrafficRule', function() {
        // TODO: update the code to test TrafficRule
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.TrafficRule);
      });

      it('should have the property trafficRuleId (base name: "trafficRuleId")', function() {
        // TODO: update the code to test the property trafficRuleId
        expect(instance).to.have.property('trafficRuleId');
        // expect(instance.trafficRuleId).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property trafficFilter (base name: "trafficFilter")', function() {
        // TODO: update the code to test the property trafficFilter
        expect(instance).to.have.property('trafficFilter');
        // expect(instance.trafficFilter).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property dstInterface (base name: "dstInterface")', function() {
        // TODO: update the code to test the property dstInterface
        expect(instance).to.have.property('dstInterface');
        // expect(instance.dstInterface).to.be(expectedValueLiteral);
      });
