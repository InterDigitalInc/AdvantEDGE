...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMetricsServiceRestApi.NetworkSubscriptionResponse = factory(root.AdvantEdgeMetricsServiceRestApi.ApiClient, root.AdvantEdgeMetricsServiceRestApi.NetworkCallbackReference, root.AdvantEdgeMetricsServiceRestApi.NetworkQueryParams);
  }
}(this, function(ApiClient, NetworkCallbackReference, NetworkQueryParams) {
  'use strict';

  /**
   * The NetworkSubscriptionResponse model module.
   * @module model/NetworkSubscriptionResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NetworkSubscriptionResponse</code>.
   * Network metrics subscription response
   * @alias module:model/NetworkSubscriptionResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>NetworkSubscriptionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetworkSubscriptionResponse} obj Optional instance to populate.
   * @return {module:model/NetworkSubscriptionResponse} The populated <code>NetworkSubscriptionResponse</code> instance.
   */
   ...
   * @member {module:model/NetworkSubscriptionResponse.SubscriptionTypeEnum} subscriptionType
   */
