...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMetricsServiceRestApi.NetworkMetrics = factory(root.AdvantEdgeMetricsServiceRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The NetworkMetrics model module.
   * @module model/NetworkMetrics
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NetworkMetrics</code>.
   * Value of a single network metric
   * @alias module:model/NetworkMetrics
   * @class
   */
  ...
  /**
   * Constructs a <code>NetworkMetrics</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetworkMetrics} obj Optional instance to populate.
   * @return {module:model/NetworkMetrics} The populated <code>NetworkMetrics</code> instance.
   */
