...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventsCallbackReference', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventsCallbackReference();
      });

      it('should create an instance of EventsCallbackReference', function() {
        // TODO: update the code to test EventsCallbackReference
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventsCallbackReference);
      });
