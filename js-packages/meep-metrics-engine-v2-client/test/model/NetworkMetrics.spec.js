...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkMetrics', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkMetrics();
      });

      it('should create an instance of NetworkMetrics', function() {
        // TODO: update the code to test NetworkMetrics
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkMetrics);
      });
