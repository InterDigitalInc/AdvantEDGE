...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkQueryResponse', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkQueryResponse();
      });

      it('should create an instance of NetworkQueryResponse', function() {
        // TODO: update the code to test NetworkQueryResponse
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkQueryResponse);
      });
