...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventQueryResponse', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventQueryResponse();
      });

      it('should create an instance of EventQueryResponse', function() {
        // TODO: update the code to test EventQueryResponse
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventQueryResponse);
      });
