...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventQueryParams', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventQueryParams();
      });

      it('should create an instance of EventQueryParams', function() {
        // TODO: update the code to test EventQueryParams
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventQueryParams);
      });
