...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventMetricsList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventMetricsList();
      });

      it('should create an instance of EventMetricsList', function() {
        // TODO: update the code to test EventMetricsList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventMetricsList);
      });
