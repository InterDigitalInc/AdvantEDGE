...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkQueryParams', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkQueryParams();
      });

      it('should create an instance of NetworkQueryParams', function() {
        // TODO: update the code to test NetworkQueryParams
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkQueryParams);
      });
