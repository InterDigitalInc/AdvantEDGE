...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkMetricsList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkMetricsList();
      });

      it('should create an instance of NetworkMetricsList', function() {
        // TODO: update the code to test NetworkMetricsList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkMetricsList);
      });
