...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventValue', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventValue();
      });

      it('should create an instance of EventValue', function() {
        // TODO: update the code to test EventValue
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventValue);
      });
