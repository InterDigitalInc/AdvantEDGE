...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkSubscriptionResponse', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkSubscriptionResponse();
      });

      it('should create an instance of NetworkSubscriptionResponse', function() {
        // TODO: update the code to test NetworkSubscriptionResponse
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkSubscriptionResponse);
      });
      ...
      it('should have the property networkQueryParams (base name: "networkQueryParams")', function() {
        // TODO: update the code to test the property networkQueryParams
        expect(instance).to.have.property('networkQueryParams');
