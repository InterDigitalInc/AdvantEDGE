...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventMetrics', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventMetrics();
      });

      it('should create an instance of EventMetrics', function() {
        // TODO: update the code to test EventMetrics
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventMetrics);
      });
