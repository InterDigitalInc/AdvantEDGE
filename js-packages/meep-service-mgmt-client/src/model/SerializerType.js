...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.SerializerType = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>SerializerType</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/SerializerType} The enum <code>SerializerType</code> value.
   */
