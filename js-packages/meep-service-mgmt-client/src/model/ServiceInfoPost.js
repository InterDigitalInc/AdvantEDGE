...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.ServiceInfoPost = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient, root.AdvantEdgeMecServiceManagementApi.CategoryRef, root.AdvantEdgeMecServiceManagementApi.LocalityType, root.AdvantEdgeMecServiceManagementApi.SerInstanceId, root.AdvantEdgeMecServiceManagementApi.SerName, root.AdvantEdgeMecServiceManagementApi.SerializerType, root.AdvantEdgeMecServiceManagementApi.ServiceState, root.AdvantEdgeMecServiceManagementApi.TransportInfo);
  }
}(this, function(ApiClient, CategoryRef, LocalityType, SerInstanceId, SerName, SerializerType, ServiceState, TransportInfo) {
  'use strict';

  /**
   * The ServiceInfoPost model module.
   * @module model/ServiceInfoPost
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>ServiceInfoPost</code>.
   * This type represents the general information of a MEC service.
   * @alias module:model/ServiceInfoPost
   * @class
   * @param serName {} 
   ...
   * @param serializer {} 
   */
  var exports = function(serName, version, state, serializer) {
    OneOfServiceInfoPost.call(this);
  ...
  /**
   * Constructs a <code>ServiceInfoPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceInfoPost} obj Optional instance to populate.
   * @return {module:model/ServiceInfoPost} The populated <code>ServiceInfoPost</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transportId'))
        obj.transportId = ApiClient.convertToType(data['transportId'], 'String');
   ...
   * @member {String} transportId
   */
  exports.prototype.transportId = undefined;
  ...
  // Implement OneOfServiceInfoPost interface:
  return exports;
