...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.TransportType = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>TransportType</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/TransportType} The enum <code>TransportType</code> value.
   */
