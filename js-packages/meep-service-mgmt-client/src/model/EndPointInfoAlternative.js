...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.EndPointInfoAlternative = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EndPointInfoAlternative model module.
   * @module model/EndPointInfoAlternative
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>EndPointInfoAlternative</code>.
   * Entry point information of the service in a format defined by an implementation, or in an external specification.
   * @alias module:model/EndPointInfoAlternative
   * @class
   * @param alternative {Object} 
   */
  ...
  /**
   * Constructs a <code>EndPointInfoAlternative</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EndPointInfoAlternative} obj Optional instance to populate.
   * @return {module:model/EndPointInfoAlternative} The populated <code>EndPointInfoAlternative</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('alternative'))
        obj.alternative = ApiClient.convertToType(data['alternative'], Object);
    }
    return obj;
  }

  /**
   * @member {Object} alternative
   */
