...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.OneOfTransportInfoEndpoint = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OneOfTransportInfoEndpoint model module.
   * @module model/OneOfTransportInfoEndpoint
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>OneOfTransportInfoEndpoint</code>.
   * @alias module:model/OneOfTransportInfoEndpoint
   * @class
   */
  ...
  /**
   * Constructs a <code>OneOfTransportInfoEndpoint</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OneOfTransportInfoEndpoint} obj Optional instance to populate.
   * @return {module:model/OneOfTransportInfoEndpoint} The populated <code>OneOfTransportInfoEndpoint</code> instance.
   */
