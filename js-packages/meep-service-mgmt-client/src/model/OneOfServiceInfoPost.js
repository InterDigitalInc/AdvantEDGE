...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMecServiceManagementApi.OneOfServiceInfoPost = factory(root.AdvantEdgeMecServiceManagementApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The OneOfServiceInfoPost model module.
   * @module model/OneOfServiceInfoPost
   * @version 2.1.1
   */

  /**
   * Constructs a new <code>OneOfServiceInfoPost</code>.
   * @alias module:model/OneOfServiceInfoPost
   * @class
   */
  ...
  /**
   * Constructs a <code>OneOfServiceInfoPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OneOfServiceInfoPost} obj Optional instance to populate.
   * @return {module:model/OneOfServiceInfoPost} The populated <code>OneOfServiceInfoPost</code> instance.
   */
