...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TimingCapsTimeStamp', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.TimingCapsTimeStamp();
      });

      it('should create an instance of TimingCapsTimeStamp', function() {
        // TODO: update the code to test TimingCapsTimeStamp
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.TimingCapsTimeStamp);
      });
