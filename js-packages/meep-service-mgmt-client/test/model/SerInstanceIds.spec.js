...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerInstanceIds', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SerInstanceIds();
      });

      it('should create an instance of SerInstanceIds', function() {
        // TODO: update the code to test SerInstanceIds
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SerInstanceIds);
      });
