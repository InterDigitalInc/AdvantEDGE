...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionLinkListLinksSubscriptions', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SubscriptionLinkListLinksSubscriptions();
      });
      ...
      it('should create an instance of SubscriptionLinkListLinksSubscriptions', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SubscriptionLinkListLinksSubscriptions);
      });
