...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndPointInfoAddressesAddresses', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.EndPointInfoAddressesAddresses();
      });

      it('should create an instance of EndPointInfoAddressesAddresses', function() {
        // TODO: update the code to test EndPointInfoAddressesAddresses
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.EndPointInfoAddressesAddresses);
      });
