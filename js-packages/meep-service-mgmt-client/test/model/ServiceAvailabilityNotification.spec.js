...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceAvailabilityNotification', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.ServiceAvailabilityNotification();
      });
      ...
      it('should create an instance of ServiceAvailabilityNotification', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.ServiceAvailabilityNotification);
      });
