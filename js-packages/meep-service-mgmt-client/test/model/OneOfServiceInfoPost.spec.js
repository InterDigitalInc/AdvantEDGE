...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OneOfServiceInfoPost', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.OneOfServiceInfoPost();
      });

      it('should create an instance of OneOfServiceInfoPost', function() {
        // TODO: update the code to test OneOfServiceInfoPost
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.OneOfServiceInfoPost);
      });
