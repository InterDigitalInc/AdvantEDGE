...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SecurityInfo', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SecurityInfo();
      });

      it('should create an instance of SecurityInfo', function() {
        // TODO: update the code to test SecurityInfo
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SecurityInfo);
      });

      it('should have the property oAuth2Info (base name: "oAuth2Info")', function() {
        // TODO: update the code to test the property oAuth2Info
        expect(instance).to.have.property('oAuth2Info');
        // expect(instance.oAuth2Info).to.be(expectedValueLiteral);
      });
