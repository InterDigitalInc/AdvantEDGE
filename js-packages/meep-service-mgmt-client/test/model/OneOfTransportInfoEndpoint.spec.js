...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OneOfTransportInfoEndpoint', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.OneOfTransportInfoEndpoint();
      });

      it('should create an instance of OneOfTransportInfoEndpoint', function() {
        // TODO: update the code to test OneOfTransportInfoEndpoint
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.OneOfTransportInfoEndpoint);
      });
