...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndPointInfoAddresses', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.EndPointInfoAddresses();
      });

      it('should create an instance of EndPointInfoAddresses', function() {
        // TODO: update the code to test EndPointInfoAddresses
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.EndPointInfoAddresses);
      });
