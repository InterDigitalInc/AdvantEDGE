...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceAvailabilityNotificationServiceReferences', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.ServiceAvailabilityNotificationServiceReferences();
      });
      ...
      it('should create an instance of ServiceAvailabilityNotificationServiceReferences', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.ServiceAvailabilityNotificationServiceReferences);
      });
