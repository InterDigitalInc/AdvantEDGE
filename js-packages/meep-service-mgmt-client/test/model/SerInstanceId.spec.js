...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerInstanceId', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SerInstanceId();
      });

      it('should create an instance of SerInstanceId', function() {
        // TODO: update the code to test SerInstanceId
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SerInstanceId);
      });
