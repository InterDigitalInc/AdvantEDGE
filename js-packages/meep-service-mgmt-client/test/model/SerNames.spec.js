...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerNames', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SerNames();
      });

      it('should create an instance of SerNames', function() {
        // TODO: update the code to test SerNames
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SerNames);
      });
