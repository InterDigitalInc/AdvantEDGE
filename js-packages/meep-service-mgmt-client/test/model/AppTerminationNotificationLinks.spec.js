...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationNotificationLinks', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationLinks();
      });
      ...
      it('should create an instance of AppTerminationNotificationLinks', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeMecApplicationSupportApi.AppTerminationNotificationLinks);
      });
