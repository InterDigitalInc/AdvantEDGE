...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndPointInfoAlternative', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.EndPointInfoAlternative();
      });

      it('should create an instance of EndPointInfoAlternative', function() {
        // TODO: update the code to test EndPointInfoAlternative
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.EndPointInfoAlternative);
      });
