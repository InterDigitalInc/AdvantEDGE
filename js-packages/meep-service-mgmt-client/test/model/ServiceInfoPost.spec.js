...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceInfoPost', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.ServiceInfoPost();
      });

      it('should create an instance of ServiceInfoPost', function() {
        // TODO: update the code to test ServiceInfoPost
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.ServiceInfoPost);
      });
      ...
      it('should have the property transportId (base name: "transportId")', function() {
        // TODO: update the code to test the property transportId
        expect(instance).to.have.property('transportId');
        // expect(instance.transportId).to.be(expectedValueLiteral);
      });
