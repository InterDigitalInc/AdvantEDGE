...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceStates', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.ServiceStates();
      });

      it('should create an instance of ServiceStates', function() {
        // TODO: update the code to test ServiceStates
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.ServiceStates);
      });
