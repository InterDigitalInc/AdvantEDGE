...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoryRefs', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.CategoryRefs();
      });

      it('should create an instance of CategoryRefs', function() {
        // TODO: update the code to test CategoryRefs
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.CategoryRefs);
      });
