...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EndPointInfoUris', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.EndPointInfoUris();
      });

      it('should create an instance of EndPointInfoUris', function() {
        // TODO: update the code to test EndPointInfoUris
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.EndPointInfoUris);
      });

      it('should have the property uris (base name: "uris")', function() {
        // TODO: update the code to test the property uris
        expect(instance).to.have.property('uris');
        // expect(instance.uris).to.be(expectedValueLiteral);
      });
