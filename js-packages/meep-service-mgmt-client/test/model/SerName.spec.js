...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SerName', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMecServiceManagementApi.SerName();
      });

      it('should create an instance of SerName', function() {
        // TODO: update the code to test SerName
        expect(instance).to.be.a(AdvantEdgeMecServiceManagementApi.SerName);
      });
