...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LogResponse', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.LogResponse();
      });

      it('should create an instance of LogResponse', function() {
        // TODO: update the code to test LogResponse
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.LogResponse);
      });
      ...
      it('should have the property src (base name: "src")', function() {
        // TODO: update the code to test the property src
