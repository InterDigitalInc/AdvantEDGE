...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.InlineResponse200();
      });

      it('should create an instance of InlineResponse200', function() {
        // TODO: update the code to test InlineResponse200
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.InlineResponse200);
      });

      it('should have the property logResponseList (base name: "logResponseList")', function() {
        // TODO: update the code to test the property logResponseList
        expect(instance).to.have.property('logResponseList');
        // expect(instance.logResponseList).to.be(expectedValueLiteral);
      });
