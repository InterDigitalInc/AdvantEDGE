...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkSubscription', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkSubscription();
      });

      it('should create an instance of NetworkSubscription', function() {
        // TODO: update the code to test NetworkSubscription
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkSubscription);
      });
