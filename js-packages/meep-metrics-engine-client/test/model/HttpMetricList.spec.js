...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HttpMetricList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.HttpMetricList();
      });

      it('should create an instance of HttpMetricList', function() {
        // TODO: update the code to test HttpMetricList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.HttpMetricList);
      });
