...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventMetricList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventMetricList();
      });

      it('should create an instance of EventMetricList', function() {
        // TODO: update the code to test EventMetricList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventMetricList);
      });
