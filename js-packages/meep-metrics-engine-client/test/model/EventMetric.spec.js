...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventMetric', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventMetric();
      });

      it('should create an instance of EventMetric', function() {
        // TODO: update the code to test EventMetric
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventMetric);
      });
