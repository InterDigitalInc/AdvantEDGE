...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LogResponseList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.LogResponseList();
      });

      it('should create an instance of LogResponseList', function() {
        // TODO: update the code to test LogResponseList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.LogResponseList);
      });

      it('should have the property logResponse (base name: "logResponse")', function() {
        // TODO: update the code to test the property logResponse
        expect(instance).to.have.property('logResponse');
        // expect(instance.logResponse).to.be(expectedValueLiteral);
      });
