...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkMetricList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.NetworkMetricList();
      });

      it('should create an instance of NetworkMetricList', function() {
        // TODO: update the code to test NetworkMetricList
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.NetworkMetricList);
      });
