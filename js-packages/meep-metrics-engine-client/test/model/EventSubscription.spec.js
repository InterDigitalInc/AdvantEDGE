...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventSubscription', function() {
      beforeEach(function() {
        instance = new AdvantEdgeMetricsServiceRestApi.EventSubscription();
      });

      it('should create an instance of EventSubscription', function() {
        // TODO: update the code to test EventSubscription
        expect(instance).to.be.a(AdvantEdgeMetricsServiceRestApi.EventSubscription);
      });
