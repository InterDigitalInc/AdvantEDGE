      ...
      describe('metricsGet', function() {
        it('should call metricsGet successfully', function(done) {
          ...
          instance.metricsGet(opts, function(error, data, response) {
            ...
            expect(data).to.be.a(MeepMetricsEngineServiceRestApi.LogResponseList);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MeepMetricsEngineServiceRestApi.LogResponse);
                ...
                expect(data.data).to.be.a(MeepMetricsEngineServiceRestApi.LogResponseData);
