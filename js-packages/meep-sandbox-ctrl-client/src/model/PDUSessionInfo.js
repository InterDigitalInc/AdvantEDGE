...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeSandboxControllerRestApi.PDUSessionInfo = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PDUSessionInfo model module.
   * @module model/PDUSessionInfo
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PDUSessionInfo</code>.
   * @alias module:model/PDUSessionInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>PDUSessionInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PDUSessionInfo} obj Optional instance to populate.
   * @return {module:model/PDUSessionInfo} The populated <code>PDUSessionInfo</code> instance.
   */
