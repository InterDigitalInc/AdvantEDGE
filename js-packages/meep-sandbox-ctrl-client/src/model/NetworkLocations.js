...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeSandboxControllerRestApi.NetworkLocations = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient, root.AdvantEdgeSandboxControllerRestApi.NetworkLocation);
  }
}(this, function(ApiClient, NetworkLocation) {
  'use strict';

  /**
   * The NetworkLocations model module.
   * @module model/NetworkLocations
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NetworkLocations</code>.
   * @alias module:model/NetworkLocations
   * @class
   */
  ...
  /**
   * Constructs a <code>NetworkLocations</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetworkLocations} obj Optional instance to populate.
   * @return {module:model/NetworkLocations} The populated <code>NetworkLocations</code> instance.
   */
