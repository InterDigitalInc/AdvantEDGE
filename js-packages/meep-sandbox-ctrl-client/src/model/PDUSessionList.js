...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeSandboxControllerRestApi.PDUSessionList = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient, root.AdvantEdgeSandboxControllerRestApi.PDUSession);
  }
}(this, function(ApiClient, PDUSession) {
  'use strict';

  /**
   * The PDUSessionList model module.
   * @module model/PDUSessionList
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PDUSessionList</code>.
   * PDUSession list
   * @alias module:model/PDUSessionList
   * @class
   */
  ...
  /**
   * Constructs a <code>PDUSessionList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PDUSessionList} obj Optional instance to populate.
   * @return {module:model/PDUSessionList} The populated <code>PDUSessionList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('sessions'))
        obj.sessions = ApiClient.convertToType(data['sessions'], [PDUSession]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:model/PDUSession>} sessions
   */
