...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./PDUSessionInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.AdvantEdgeSandboxControllerRestApi) {
      root.AdvantEdgeSandboxControllerRestApi = {};
    }
    root.AdvantEdgeSandboxControllerRestApi.PDUSession = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient, root.AdvantEdgeSandboxControllerRestApi.PDUSessionInfo);
  }
}(this, function(ApiClient, PDUSessionInfo) {
  'use strict';

  /**
   * The PDUSession model module.
   * @module model/PDUSession
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PDUSession</code>.
   * PDU Session
   * @alias module:model/PDUSession
   * @class
   */
  ...
  /**
   * Constructs a <code>PDUSession</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PDUSession} obj Optional instance to populate.
   * @return {module:model/PDUSession} The populated <code>PDUSession</code> instance.
   */
