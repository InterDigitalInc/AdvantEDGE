...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeSandboxControllerRestApi.Processes = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient, root.AdvantEdgeSandboxControllerRestApi.Process);
  }
}(this, function(ApiClient, Process) {
  'use strict';

  /**
   * The Processes model module.
   * @module model/Processes
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Processes</code>.
   * @alias module:model/Processes
   * @class
   */
  ...
  /**
   * Constructs a <code>Processes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Processes} obj Optional instance to populate.
   * @return {module:model/Processes} The populated <code>Processes</code> instance.
   */
