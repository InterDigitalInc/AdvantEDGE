...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeSandboxControllerRestApi.PhysicalLocations = factory(root.AdvantEdgeSandboxControllerRestApi.ApiClient, root.AdvantEdgeSandboxControllerRestApi.PhysicalLocation);
  }
}(this, function(ApiClient, PhysicalLocation) {
  'use strict';

  /**
   * The PhysicalLocations model module.
   * @module model/PhysicalLocations
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PhysicalLocations</code>.
   * @alias module:model/PhysicalLocations
   * @class
   */
  ...
  /**
   * Constructs a <code>PhysicalLocations</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PhysicalLocations} obj Optional instance to populate.
   * @return {module:model/PhysicalLocations} The populated <code>PhysicalLocations</code> instance.
   */
