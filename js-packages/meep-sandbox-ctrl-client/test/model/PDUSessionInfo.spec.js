...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PDUSessionInfo', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.PDUSessionInfo();
      });

      it('should create an instance of PDUSessionInfo', function() {
        // TODO: update the code to test PDUSessionInfo
