...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Domains', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.Domains();
      });

      it('should create an instance of Domains', function() {
        // TODO: update the code to test Domains
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.Domains);
      });
