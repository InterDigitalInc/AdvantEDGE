...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventPduSession', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.EventPduSession();
      });

      it('should create an instance of EventPduSession', function() {
        // TODO: update the code to test EventPduSession
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.EventPduSession);
      });
      ...
      it('should have the property pduSession (base name: "pduSession")', function() {
        // TODO: update the code to test the property pduSession
        expect(instance).to.have.property('pduSession');
        // expect(instance.pduSession).to.be(expectedValueLiteral);
      });
