...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NodeDataUnion', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.NodeDataUnion();
      });

      it('should create an instance of NodeDataUnion', function() {
        // TODO: update the code to test NodeDataUnion
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.NodeDataUnion);
      });

      it('should have the property physicalLocation (base name: "physicalLocation")', function() {
        // TODO: update the code to test the property physicalLocation
        expect(instance).to.have.property('physicalLocation');
