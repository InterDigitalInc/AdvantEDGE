...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PhysicalLocations', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.PhysicalLocations();
      });

      it('should create an instance of PhysicalLocations', function() {
        // TODO: update the code to test PhysicalLocations
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.PhysicalLocations);
      });
