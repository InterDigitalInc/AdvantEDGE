...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Processes', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.Processes();
      });

      it('should create an instance of Processes', function() {
        // TODO: update the code to test Processes
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.Processes);
      });
