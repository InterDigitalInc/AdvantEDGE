...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PDUSessionList', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.PDUSessionList();
      });

      it('should create an instance of PDUSessionList', function() {
        // TODO: update the code to test PDUSessionList
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.PDUSessionList);
      });

      it('should have the property sessions (base name: "sessions")', function() {
        // TODO: update the code to test the property sessions
        expect(instance).to.have.property('sessions');
        // expect(instance.sessions).to.be(expectedValueLiteral);
      });
