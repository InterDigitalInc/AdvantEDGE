...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventScenarioUpdate', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.EventScenarioUpdate();
      });

      it('should create an instance of EventScenarioUpdate', function() {
        // TODO: update the code to test EventScenarioUpdate
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.EventScenarioUpdate);
      });
