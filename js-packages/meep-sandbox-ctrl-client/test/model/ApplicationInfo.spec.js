...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApplicationInfo', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.ApplicationInfo();
      });

      it('should create an instance of ApplicationInfo', function() {
        // TODO: update the code to test ApplicationInfo
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.ApplicationInfo);
      });
