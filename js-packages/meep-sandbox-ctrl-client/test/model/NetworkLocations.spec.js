...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkLocations', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.NetworkLocations();
      });

      it('should create an instance of NetworkLocations', function() {
        // TODO: update the code to test NetworkLocations
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.NetworkLocations);
      });
