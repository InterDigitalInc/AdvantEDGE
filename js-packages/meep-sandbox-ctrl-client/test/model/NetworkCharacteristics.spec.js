...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkCharacteristics', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.NetworkCharacteristics();
      });

      it('should create an instance of NetworkCharacteristics', function() {
        // TODO: update the code to test NetworkCharacteristics
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.NetworkCharacteristics);
      });
