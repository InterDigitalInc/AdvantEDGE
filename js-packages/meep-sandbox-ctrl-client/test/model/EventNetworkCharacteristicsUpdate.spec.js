...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventNetworkCharacteristicsUpdate', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.EventNetworkCharacteristicsUpdate();
      });
      ...
      it('should create an instance of EventNetworkCharacteristicsUpdate', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.EventNetworkCharacteristicsUpdate);
      });
