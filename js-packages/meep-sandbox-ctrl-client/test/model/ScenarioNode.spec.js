...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScenarioNode', function() {
      beforeEach(function() {
        instance = new AdvantEdgeSandboxControllerRestApi.ScenarioNode();
      });

      it('should create an instance of ScenarioNode', function() {
        // TODO: update the code to test ScenarioNode
        expect(instance).to.be.a(AdvantEdgeSandboxControllerRestApi.ScenarioNode);
      });
      ...
      it('should have the property nodeDataUnion (base name: "nodeDataUnion")', function() {
        // TODO: update the code to test the property nodeDataUnion
        expect(instance).to.have.property('nodeDataUnion');
        // expect(instance.nodeDataUnion).to.be(expectedValueLiteral);
      });
