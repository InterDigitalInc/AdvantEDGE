    ...
    describe('EventReplayApi', function() {
      describe('createReplayFile', function() {
        it('should call createReplayFile successfully', function(done) {
          ...
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.id = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.name = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.type = "UE";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.isExternal = false;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData = new AdvantEdgeSandboxControllerRestApi.GeoData();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.location = new AdvantEdgeSandboxControllerRestApi.Point();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.location.type = "Point";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.location.coordinates = [];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.radius = ;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.path = new AdvantEdgeSandboxControllerRestApi.LineString();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.path.type = "LineString";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.geoData.path.coordinates = [[]];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.networkLocationsInRange = [""];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.meta = {key: ""};
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.userMeta = {key: ""};
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes = [new AdvantEdgeSandboxControllerRestApi.Process()];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].id = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].name = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].type = "UE-APP";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].isExternal = false;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].image = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].environment = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].commandArguments = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].commandExe = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig = new AdvantEdgeSandboxControllerRestApi.ServiceConfig();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.name = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.meSvcName = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.ports = [new AdvantEdgeSandboxControllerRestApi.ServicePort()];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.ports[0].protocol = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.ports[0].port = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].serviceConfig.ports[0].externalPort = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].gpuConfig = new AdvantEdgeSandboxControllerRestApi.GpuConfig();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].gpuConfig.type = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].gpuConfig.count = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig = new AdvantEdgeSandboxControllerRestApi.ExternalConfig();
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.ingressServiceMap = [new AdvantEdgeSandboxControllerRestApi.IngressService()];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.ingressServiceMap[0].name = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.ingressServiceMap[0].port = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.ingressServiceMap[0].externalPort = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.ingressServiceMap[0].protocol = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap = [new AdvantEdgeSandboxControllerRestApi.EgressService()];
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap[0].name = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap[0].meSvcName = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap[0].ip = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap[0].port = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].externalConfig.egressServiceMap[0].protocol = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].status = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].userChartLocation = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].userChartAlternateValues = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].userChartGroup = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].meta = {key: ""};
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].userMeta = {key: ""};
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].appLatency = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].appLatencyVariation = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].appThroughput = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].appPacketLoss = 0.0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.processes[0].placementId = "";
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.linkLatency = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.linkLatencyVariation = 0;
          replayFile.events[0].event.eventScenarioUpdate.nodes[0].nodeDataUnion.physicalLocation.linkThroughput = 0;
              ...
              for (let p in dataCtr) {
                ...
                expect(data.event).to.be.a(AdvantEdgeSandboxControllerRestApi.Event);
                  ...
                  expect(data.event.eventScenarioUpdate).to.be.a(AdvantEdgeSandboxControllerRestApi.EventScenarioUpdate);
                    ...
                    {
                      let dataCtr = data.event.eventScenarioUpdate.nodes;
                      expect(dataCtr).to.be.an(Array);
                      expect(dataCtr).to.not.be.empty();
                      for (let p in dataCtr) {
                        let data = dataCtr[p];
                        ...
                        expect(data.nodeDataUnion).to.be.a(AdvantEdgeSandboxControllerRestApi.NodeDataUnion);
                              expect(data.nodeDataUnion.physicalLocation).to.be.a(AdvantEdgeSandboxControllerRestApi.PhysicalLocation);
                                expect(data.nodeDataUnion.physicalLocation.id).to.be.a('string');
                            expect(data.nodeDataUnion.physicalLocation.id).to.be("");
                            expect(data.nodeDataUnion.physicalLocation.name).to.be.a('string');
                            expect(data.nodeDataUnion.physicalLocation.name).to.be("");
                            expect(data.nodeDataUnion.physicalLocation.type).to.be.a('string');
                            expect(data.nodeDataUnion.physicalLocation.type).to.be("UE");
                            expect(data.nodeDataUnion.physicalLocation.isExternal).to.be.a('boolean');
                            expect(data.nodeDataUnion.physicalLocation.isExternal).to.be(false);
                            expect(data.nodeDataUnion.physicalLocation.geoData).to.be.a(AdvantEdgeSandboxControllerRestApi.GeoData);
                                  expect(data.nodeDataUnion.physicalLocation.geoData.location).to.be.a(AdvantEdgeSandboxControllerRestApi.Point);
                                    expect(data.nodeDataUnion.physicalLocation.geoData.location.type).to.be.a('string');
                                expect(data.nodeDataUnion.physicalLocation.geoData.location.type).to.be("Point");
                                {
                                  let dataCtr = data.nodeDataUnion.physicalLocation.geoData.location.coordinates;
                                  expect(dataCtr).to.be.an(Array);
                                  expect(dataCtr).to.not.be.empty();
                                  for (let p in dataCtr) {
                                    let data = dataCtr[p];
                              ...
                              expect(data.nodeDataUnion.physicalLocation.geoData.radius).to.be.a('number');
                              expect(data.nodeDataUnion.physicalLocation.geoData.radius).to.be();
                              expect(data.nodeDataUnion.physicalLocation.geoData.path).to.be.a(AdvantEdgeSandboxControllerRestApi.LineString);
                                    expect(data.nodeDataUnion.physicalLocation.geoData.path.type).to.be.a('string');
                                expect(data.nodeDataUnion.physicalLocation.geoData.path.type).to.be("LineString");
                                {
                                  let dataCtr = data.nodeDataUnion.physicalLocation.geoData.path.coordinates;
                                  expect(dataCtr).to.be.an(Array);
                                  expect(dataCtr).to.not.be.empty();
                                  for (let p in dataCtr) {
                                    let data = dataCtr[p];
                            ...
                            {
                              let dataCtr = data.nodeDataUnion.physicalLocation.networkLocationsInRange;
                              expect(dataCtr).to.be.an(Array);
                              expect(dataCtr).to.not.be.empty();
                              for (let p in dataCtr) {
                                let data = dataCtr[p];
                            ...
                            {
                              let dataCtr = data.nodeDataUnion.physicalLocation.meta;
                            ...
                            {
                              let dataCtr = data.nodeDataUnion.physicalLocation.userMeta;
                              expect(dataCtr).to.be.an(Object);
                              expect(dataCtr).to.not.be.empty();
                              for (let p in dataCtr) {
                                let data = dataCtr[p];
                            ...
                            {
                              let dataCtr = data.nodeDataUnion.physicalLocation.processes;
                              expect(dataCtr).to.be.an(Array);
                              expect(dataCtr).to.not.be.empty();
                              for (let p in dataCtr) {
                                let data = dataCtr[p];
                            ...
                            expect(data.nodeDataUnion.physicalLocation.linkLatency).to.be.a('number');
                            expect(data.nodeDataUnion.physicalLocation.linkLatency).to.be(0);
                            expect(data.nodeDataUnion.physicalLocation.linkLatencyVariation).to.be.a('number');
                            expect(data.nodeDataUnion.physicalLocation.linkLatencyVariation).to.be(0);
                            expect(data.nodeDataUnion.physicalLocation.linkThroughput).to.be.a('number');
                            expect(data.nodeDataUnion.physicalLocation.linkThroughput).to.be(0);
                            expect(data.nodeDataUnion.physicalLocation.linkPacketLoss).to.be.a('number');
                            expect(data.nodeDataUnion.physicalLocation.linkPacketLoss).to.be(0.0);
