...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Sandbox', 'api/AuthApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Sandbox'), require('./api/AuthApi'));
  }
}(function(ApiClient, Sandbox, AuthApi) {
  'use strict';

  /**
   * This_API_provides_microservice_API_authentication__authorization_services_pMicro_servicebr_meep_auth_httpsgithub_comInterDigitalIncAdvantEDGEtreemastergo_appsmeep_auth_pType__UsagebrPlatform_interface_used_by_ingress_to_authenticate__authorize_microservice_API_access_pDetailsbrAPI_details_available_at__your_AdvantEDGE_ip_addressapi_.<br>
