...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeAuthServiceRestApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/auth/v1
     */
    this.basePath = 'https://localhost/auth/v1'.replace(/\/+$/, '');
