...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeMonitoringEngineRestApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/mon-engine/v1
     */
    this.basePath = 'https://localhost/mon-engine/v1'.replace(/\/+$/, '');
