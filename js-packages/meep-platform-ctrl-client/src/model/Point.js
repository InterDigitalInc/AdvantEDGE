...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgePlatformControllerRestApi.Point = factory(root.AdvantEdgePlatformControllerRestApi.ApiClient);
  }
   ...
   * @class
   * @param type {module:model/Point.TypeEnum} Must be Point
   */
