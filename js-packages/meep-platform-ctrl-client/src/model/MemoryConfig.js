...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgePlatformControllerRestApi.MemoryConfig = factory(root.AdvantEdgePlatformControllerRestApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MemoryConfig model module.
   * @module model/MemoryConfig
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>MemoryConfig</code>.
   * Memory configuration object
   * @alias module:model/MemoryConfig
   * @class
   */
  ...
  /**
   * Constructs a <code>MemoryConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MemoryConfig} obj Optional instance to populate.
   * @return {module:model/MemoryConfig} The populated <code>MemoryConfig</code> instance.
   */
