...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>D2dConfig</code>.
   * D2D config
  ...
  /**
   * Constructs a <code>D2dConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/D2dConfig} obj Optional instance to populate.
   * @return {module:model/D2dConfig} The populated <code>D2dConfig</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('d2dMinDistance'))
        obj.d2dMinDistance = ApiClient.convertToType(data['d2dMinDistance'], 'Number');
   ...
   * @member {Number} d2dMinDistance
   */
  exports.prototype.d2dMinDistance = undefined;
