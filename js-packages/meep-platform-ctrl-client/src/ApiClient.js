...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgePlatformControllerRestApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/platform-ctrl/v1
     */
    this.basePath = 'https://localhost/platform-ctrl/v1'.replace(/\/+$/, '');
