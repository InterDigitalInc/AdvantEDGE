...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConnectivityConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ConnectivityConfig();
      });

      it('should create an instance of ConnectivityConfig', function() {
        // TODO: update the code to test ConnectivityConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ConnectivityConfig);
      });
