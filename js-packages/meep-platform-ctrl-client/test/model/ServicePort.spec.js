...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServicePort', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ServicePort();
      });

      it('should create an instance of ServicePort', function() {
        // TODO: update the code to test ServicePort
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ServicePort);
      });
