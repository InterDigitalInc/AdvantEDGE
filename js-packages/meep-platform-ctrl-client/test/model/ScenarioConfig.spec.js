...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScenarioConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.ScenarioConfig();
      });

      it('should create an instance of ScenarioConfig', function() {
        // TODO: update the code to test ScenarioConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.ScenarioConfig);
      });
