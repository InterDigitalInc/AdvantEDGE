...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MemoryConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.MemoryConfig();
      });

      it('should create an instance of MemoryConfig', function() {
        // TODO: update the code to test MemoryConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.MemoryConfig);
      });
