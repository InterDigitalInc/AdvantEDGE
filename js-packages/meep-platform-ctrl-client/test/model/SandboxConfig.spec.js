...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SandboxConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.SandboxConfig();
      });

      it('should create an instance of SandboxConfig', function() {
        // TODO: update the code to test SandboxConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.SandboxConfig);
      });
