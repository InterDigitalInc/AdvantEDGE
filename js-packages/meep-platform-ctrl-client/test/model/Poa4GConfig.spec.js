...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Poa4GConfig', function() {
      beforeEach(function() {
        instance = new AdvantEdgePlatformControllerRestApi.Poa4GConfig();
      });

      it('should create an instance of Poa4GConfig', function() {
        // TODO: update the code to test Poa4GConfig
        expect(instance).to.be.a(AdvantEdgePlatformControllerRestApi.Poa4GConfig);
      });
