...
// ApplicationState : This enumeration defines the possible states of an application.
type ApplicationState string

// List of ApplicationState
const (
	APPLICATION_STATE_ACTIVE   ApplicationState = "ACTIVE"
	APPLICATION_STATE_INACTIVE ApplicationState = "INACTIVE"
)
