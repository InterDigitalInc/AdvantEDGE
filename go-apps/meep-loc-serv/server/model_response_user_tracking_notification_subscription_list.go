...
type ResponseUserTrackingNotificationSubscriptionList struct {
	NotificationSubscriptionList *UserTrackingNotificationSubscriptionList `json:"notificationSubscriptionList,omitempty"`
}
