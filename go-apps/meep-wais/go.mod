module github.com/InterDigitalInc/AdvantEDGE/go-apps/meep-wais
...
require (
	...
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-rnis-notification-client v0.0.0-20200703133018-94138d8210a3 // indirect
