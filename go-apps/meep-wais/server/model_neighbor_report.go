...
type NeighborReport struct {
	...
	// Additional information related to Access Point being reported.
	BssidInfo int32 `json:"bssidInfo"`

	// Channel set of the AP.
	OperatingClass int32 `json:"operatingClass"`

	// Channel currently used by this Access Point.
	Channel int32 `json:"channel"`

	// PHY type of the AP indicated by this BSSID.
	PhyType int32 `json:"phyType"`

	OptionalSubelement *OptionalSubelement `json:"optionalSubelement,omitempty"`
}
