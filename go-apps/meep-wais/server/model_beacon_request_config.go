...
type BeaconRequestConfig struct {
	...
	// Measurement mode (0-passive, 1-active, 2-beacon table).
	MeasurementMode int32 `json:"measurementMode"`

	// Channel number where the beacon was received.
	ChannelId int32 `json:"channelId"`

	// BssId of the BSS for which a beacon report has been received.
	BssId []string `json:"bssId"`

	// ESS or IBSS for which a beacon report is received.
