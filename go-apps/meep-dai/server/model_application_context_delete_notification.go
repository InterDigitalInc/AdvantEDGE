...
type ApplicationContextDeleteNotification struct {
	// Uniquely identifies the application context that has been deleted from the MEC system.
	ContextId string `json:"contextId"`
	// Shall be set to \"ApplicationContextDeleteNotification\".
