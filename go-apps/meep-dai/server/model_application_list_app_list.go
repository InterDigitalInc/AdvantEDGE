...
type ApplicationListAppList struct {
	AppInfo *ApplicationListAppInfo `json:"appInfo,omitempty"`

	VendorSpecificExt *ApplicationListVendorSpecificExt `json:"vendorSpecificExt,omitempty"`
}
