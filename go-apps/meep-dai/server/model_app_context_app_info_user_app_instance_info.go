...
type AppContextAppInfoUserAppInstanceInfo struct {
	// Identifier of the user application instance. It shall only be included in the response.
	AppInstanceId string `json:"appInstanceId,omitempty"`

	AppLocation *LocationConstraints `json:"appLocation,omitempty"`
	// Address of the user application instance. It shall only be included in the response.
