module github.com/InterDigitalInc/AdvantEDGE/go-apps/meep-dai

go 1.12

require (
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-app-support-client v0.0.0
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-dai-client v0.0.0 // indirect
	...
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-gis-engine-client v0.0.0-20211214133749-f203f7ab4f1c
