...
const (
	SUBSCRIPTION_TYPE_RESERVED           SubscriptionType = 0
	SUBSCRIPTION_TYPE_MOBILITY_PROCEDURE SubscriptionType = 1
	SUBSCRIPTION_TYPE_ADJACENT_APPINFO   SubscriptionType = 2
)
