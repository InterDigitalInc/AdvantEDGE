...
const (
	MOBILITY_STATUS_TRIGGERED MobilityStatus = "INTERHOST_MOVEOUT_TRIGGERED"
	MOBILITY_STATUS_COMPLETED MobilityStatus = "INTERHOST_MOVEOUT_COMPLETED"
	MOBILITY_STATUS_FAILED    MobilityStatus = "INTERHOST_MOVEOUT_FAILED"
)
