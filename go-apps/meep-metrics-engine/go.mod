...
require (
	...
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-metrics-engine-v2-notification-client v0.0.0
...
replace (
	...
	github.com/InterDigitalInc/AdvantEDGE/go-packages/meep-metrics-engine-v2-notification-client => ../../go-packages/meep-metrics-engine-v2-notification-client
