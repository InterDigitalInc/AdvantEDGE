...
func main() {
	...
	log.Info("Starting Edge Platform App Enablement Service")
	...
	go func() {
		// Initialize Edge Platform App Enablement Service
		err := server.Init()
		if err != nil {
			log.Error("Failed to initialize Edge Platform App Enablement Service")
			run = false
			return
		}

		// Start Edge Platform App Enablement Service Event Handler thread
		err = server.Run()
		if err != nil {
			log.Error("Failed to start Edge Platform App Enablement Service")
			run = false
			return
		}
